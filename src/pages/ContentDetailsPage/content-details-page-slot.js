...
import { ContentDetailsProvider } from "./ContentDetailsSlot/contentdetailscontainer";
import Footer from "../../components/Footer/footer";
import { TrayWebSeriesEpisodesDetail } from "../../components/ContentDetails/TrayWebSeriesEpisodesDetail/TrayWebSeriesEpisodesDetail";
...
import CastDetails from "../../components/ContentDetails/CastDetails/CastDetailsCarousalView";
...
function ContentDetailsPageContent({ user }) {
  ...
  const movie_id = window.location.pathname.replace("/content/", "");
  let splitMovieId = movie_id.split("/");
  let categoryId = splitMovieId[0];
